    ...
    <section className="relative rounded-2xl p-10 shadow-lg flex flex-col md:flex-row items-center gap-10 overflow-hidden bg-[#141517b8] border border-[#232b36]">
      ...
      <div className="flex-1">
        ...
        <p className="text-gray-300 text-lg font-medium max-w-2xl mb-8 leading-relaxed">
          ...
          <span className="text-[#00F078] font-semibold">actionable intelligence</span> in seconds. 
          Our IOC reconnaissance engine provides comprehensive analysis with 
          <span className="text-[#00F078] font-semibold"> historical context</span> and 
          <span className="text-[#00F078] font-semibold"> threat actor attribution</span>.
        </p>
