  ...
  return (
    ...
    >
      ...
      <p className="text-gray-300 max-w-4xl mx-auto text-center mb-14 leading-relaxed text-lg">
        ThreatIntel Pro delivers advanced, real-time threat intelligence to empower cybersecurity teams with deep insights, automated detection, and comprehensive analysis. 
        Our platform seamlessly integrates with your existing security infrastructure, enabling smooth workflows for incident response, threat hunting, and risk mitigation.
      </p>
      ...
      <div className="grid gap-14 md:grid-cols-3">
        ...
        <div>
          ...
          <ul className="list-disc list-inside text-gray-300 space-y-2 text-base">
            <li>Real-time data collection & enrichment from multiple global sources</li>
            <li>Automated IOC analysis and attribution with confidence scoring</li>
        ...
        <div>
          ...
          <ul className="list-disc list-inside text-gray-300 space-y-2 text-base">
            ...
            <li>APIs for easy integration with firewalls, endpoint protection, and ticketing tools</li>
            <li>Support for STIX, TAXII, JSON, and CSV data formats</li>
            <li>Cloud-native architecture for scalability and reliability</li>
            <li>Flexible deployment across hybrid and multi-cloud environments</li>
          </ul>
        </div>

        {/* User Workflow */}
        <div>
          <h3 className="text-2xl font-bold text-white mb-4">User Workflow Demonstration</h3>
          <ol className="list-decimal list-inside text-gray-300 space-y-3 text-base">
            <li><span className="font-semibold text-white">Collect</span> - Gather intelligence from open source, dark web, and internal sensors.</li>
            <li><span className="font-semibold text-white">Analyze</span> - Correlate and enrich raw data with context and threat actor profiles.</li>
            <li><span className="font-semibold text-white">Respond</span> - Deliver prioritized alerts and actionable insights for rapid mitigation.</li>
          </ol>
        </div>
      </div>
