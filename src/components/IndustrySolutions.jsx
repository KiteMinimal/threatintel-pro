...
const industries = [
  {
    ...
    badge: "/finance-badge.svg", // Replace with your badge/logo or icon
  },
  {
    title: "Healthcare",
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-300 text-lg text-center max-w-3xl mx-auto mb-14">
        ThreatIntel Pro delivers tailored intelligence and compliance peace of mind for every vertical. See how key industries benefit from our actionable insights and case-driven solutions.
      </p>
      ...
      <div className="mt-16 flex flex-wrap justify-center items-center gap-10 max-w-4xl mx-auto">
        ...
        <img src="/case-customer1.svg" alt="Customer 1" className="h-10 grayscale opacity-80 hover:opacity-100 transition" />
        <img src="/case-customer2.svg" alt="Customer 2" className="h-10 grayscale opacity-80 hover:opacity-100 transition" />
        <img src="/case-recognition1.svg" alt="Award" className="h-10 grayscale opacity-80 hover:opacity-100 transition" />
        <img src="/case-recognition2.svg" alt="Certification" className="h-10 grayscale opacity-80 hover:opacity-100 transition" />
      </div>
    </section>
  );
}
